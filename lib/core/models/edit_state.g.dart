...
Map<String, dynamic> _$$EditStateImplToJson(_$EditStateImpl instance) =>
    <String, dynamic>{
      ...
      'basicEditor': instance.basicEditor.toJson(),
      'lensProfile': instance.lensProfile?.toJson(),
      'cameraProfile': instance.cameraProfile?.toJson(),
      'filmStock': instance.filmStock?.toJson(),
      'grain': instance.grain.toJson(),
      'bloom': instance.bloom.toJson(),
